...
var _loginTemplate = require('./login.template.js');

var _loginTemplate2 = _interopRequireDefault(_loginTemplate);

var _indexTemplate = require('./index.template.js');
 ...
 */
var promiseify = function promiseify(f) {
  return function () {
...
var sendLoginInfo = function sendLoginInfo() {
  var info = chrome.storage.sync.get('info');

  chrome.tabs.query({
    active: true,
    currentWindow: true
  }, function (tabs) {
    var token = chrome.storage.sync.get('token');
    chrome.tabs.sendMessage(tabs[0].id, { from: 'popup', payload: { info: JSON.parse(info), token: token } }, function (res) {
...
var initLogin = function initLogin() {
  (0, _jquery2.default)('#app').append(_loginTemplate2.default);

  (0, _jquery2.default)('#login').submit(function (e) {
    e.preventDefault();
    ...
    fetch(host + '/login', {
      ...
      body: JSON.stringify({
        user: (0, _jquery2.default)('#user')[0].value,
        password: (0, _jquery2.default)('#password')[0].value
      })
    }).then(function (res) {
      return res.json();
    }).then(function (data) {
      ...
      var html = (0, _indexTemplate2.default)(data.user);
      (0, _jquery2.default)('#app').empty();
      (0, _jquery2.default)('#app').append(html);
      (0, _jquery2.default)('#logout').click(function () {
  ...
  (0, _jquery2.default)("#signup").submit(function (e) {
    e.preventDefault();
    fetch(host + '/signup', {
      method: 'POST',
      headers: {
      ...
      body: JSON.stringify({
        user: (0, _jquery2.default)('#user1')[0].value,
        password: (0, _jquery2.default)('#password1')[0].value
      })
    }).then(function (res) {
      return res.json();
    }).then(function (res) {
      if (res.status == 'ok') {
        (0, _jquery2.default)('.tip').remove();
        (0, _jquery2.default)('#signup').append('<p class="tip">注册成功</p>');
      } else {
        (0, _jquery2.default)('.tip').remove();
        (0, _jquery2.default)('#signup').append('<p class="tip">注册失败</p>');
      }
    });
  });
};
...
(0, _jquery2.default)(document).ready(function () {
  ...
  chrome.storage.local.get(['token', 'user'], function (data) {
    ...
    if (!userToken || !user) {
      ...
      var html = (0, _indexTemplate2.default)(user);
      (0, _jquery2.default)('#app').append(html);
      (0, _jquery2.default)('#logout').click(function () {
        chrome.storage.local.clear();
      });
...
___scope___.file("login.template.js", function(exports, require, module, __filename, __dirname){ 
...
___scope___.file("index.template.js", function(exports, require, module, __filename, __dirname){ 
